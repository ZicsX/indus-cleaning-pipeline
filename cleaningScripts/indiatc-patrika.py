...
("remove_line_with_pattern", [r"^.*Published.*$",r"^.*Updated.*$" ]),
("remove_line_and_below", ["Next Article","संपादक की पसंद"]),
(
    "remove_line_with_keyword",
    [
        "Hindi News","hindi news", "Updated", "Published by", "Link Copied",
        "Follow Us", "Next Article", "Followed", "News in Hindi", "Hindi news",
        "सब्सक्राइब करें", "डाउनलोड करें", "सब्सक्रिप्शन", "Disclaimer", "एड फ्री अनुभव",
        "Get all Sports", "ब्यूरो", "ब्यूरो,", "Get all India News", "Read the latest",
